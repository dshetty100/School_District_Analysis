...
## Results
The code for the analysis of the election audit can be found here, http://github.com/dshetty100/School_District_Analysis .
...
Summary for each school in the district:
